...
@test in(Dict(:tablename => "notifiable_disease_reports", :status => "linked with criteria ID 4", :nrecords => 1), result)
@test in(Dict(:tablename => "notifiable_disease_reports", :status => "linked with criteria ID 5", :nrecords => 1), result)
@test in(Dict(:tablename => "notifiable_disease_reports", :status => "linked with criteria ID 6", :nrecords => 1), result)
@test in(Dict(:tablename => "notifiable_disease_reports", :status => "linked with criteria ID 7", :nrecords => 1), result)
@test in(Dict(:tablename => "notifiable_disease_reports", :status => "unlinked",                  :nrecords => 4), result)
