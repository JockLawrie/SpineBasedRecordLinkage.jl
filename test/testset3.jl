...
@test in(Dict(:tablename => "spine", :status1 => "existent",    :status2 => "existent",    :nrecords => 3), result)
@test in(Dict(:tablename => "spine", :status1 => "existent",    :status2 => "nonexistent", :nrecords => 1), result)
@test in(Dict(:tablename => "spine", :status1 => "nonexistent", :status2 => "existent",    :nrecords => 3), result)
