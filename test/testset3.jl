...
@test in(Dict(:tablename => "influenza_cases", :status1 => "linked with criteria ID 4", :status2 => "linked with criteria ID 4", :nrecords => 1), result)
@test in(Dict(:tablename => "influenza_cases", :status1 => "linked with criteria ID 5", :status2 => "linked with criteria ID 5", :nrecords => 1), result)
...
@test in(Dict(:tablename => "influenza_cases", :status1 => "unlinked",                  :status2 => "linked with criteria ID 4", :nrecords => 2), result)
@test in(Dict(:tablename => "influenza_cases", :status1 => "unlinked",                  :status2 => "linked with criteria ID 5", :nrecords => 1), result)
@test in(Dict(:tablename => "influenza_cases", :status1 => "unlinked",                  :status2 => "linked with criteria ID 7", :nrecords => 1), result)
